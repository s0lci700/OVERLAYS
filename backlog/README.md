...
One file per task, grouped by phase. Synced from the [Notion Roadmap database](https://www.notion.so/31eb63b6f5ec81e5a168cf7d204b6d78).

**Source of truth:** Notion. Run `/doc-steward backlog-sync` to pull latest state into these files and regenerate `SPRINT.md`.
...
| Phase 6 — Prep App | `phase-6/` | Pitch Ready | 📋 Planned | — |
| Phase 7 — DX & Polish | `phase-7/` | Pitch Ready | 📋 Planned | — |
...
|----|-------|--------|-----|---------|
| [TASK-0.1](phase-0/TASK-0.1.md) | Standardize naming conventions across codebase | ✅ Done | 3 | 🏗 Foundation |
| [TASK-0.2](phase-0/TASK-0.2.md) | Define shared contract type modules | ✅ Done | 5 | 🏗 Foundation |
| [TASK-0.3](phase-0/TASK-0.3.md) | Align SvelteKit directory to surface map | ✅ Done | 3 | 🏗 Foundation |
| [TASK-0.4](phase-0/TASK-0.4.md) | Establish services layer scaffold | ✅ Done | 5 | 🏗 Foundation |
| [TASK-0.5](phase-0/TASK-0.5.md) | Sync architecture docs to repo | ✅ Done | 3 | 🔧 DX |
| [TASK-0.6](phase-0/TASK-0.6.md) | Set up Storybook with surface-based organization | ✅ Done | 8 | 🔧 DX |
| [TASK-0.7](phase-0/TASK-0.7.md) | Create canonical mock fixture files | ✅ Done | 3 | 🔧 DX |
