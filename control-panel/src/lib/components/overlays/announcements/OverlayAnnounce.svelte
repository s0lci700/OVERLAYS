...
<script>
	...
	import {
		...
		slideOutToLeft,
		typewriterReveal
	} from '$lib/components/overlays/shared/animations.js';
...
<style>
	...
	.announce-card {
		...
		border-top: 3px solid var(--red, #ff4d6a);
		border-radius: 6px;
		padding: 40px 56px;
		min-width: 480px;
		max-width: 860px;
