<!--
  PlayerSheet — mobile character sheet for a single player.
  Read-only view. Receives a `character` prop (live or mock).
  ...
  <div class="player-sheet">
    ...
    {#if character.proficiencies?.skills?.length > 0}
      <section class="ps-section">
        ...
        <div class="ps-skills">
          {#each character.proficiencies.skills as skill (skill)}
    ...
    {#if character.equipment?.items?.length > 0}
      <section class="ps-section">
        ...
        <ul class="ps-equipment">
          {#each character.equipment.items as item (item)}
    ...
    {#if character.species?.traits?.length > 0}
      <section class="ps-section">
        ...
        <div class="ps-skills">
          {#each character.species.traits as trait (trait)}
