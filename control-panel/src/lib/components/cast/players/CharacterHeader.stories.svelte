<script module>
  ...
  const NO_SUBCLASS = { ...SIR_NABO, subclass_name: undefined };

  const { Story } = defineMeta({
    title: 'Cast/Players/CharacterHeader',
...
<Story name="Default — Sir Nabo" args={{ character: SIR_NABO }} />
<Story name="No Subclass" args={{ character: NO_SUBCLASS }} />
<Story name="Mage (Gnome/Wizard)" args={{ character: MAGE_BRUM }} />
