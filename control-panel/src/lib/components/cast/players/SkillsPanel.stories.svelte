<script module>
  ...
  const { Story } = defineMeta({
    title: 'Cast/Players/SkillsPanel',
...
<Story name="Grouped by Ability — Fighter" args={{ character: SIR_NABO }} />
<Story name="Grouped by Ability — Mage (Expertise)" args={{ character: MAGE_BRUM }} />
<Story name="Sorted by Modifier — Mage" args={{ character: MAGE_BRUM, groupByAbility: false, sortByModifier: true }} />
<Story name="No Proficiencies" args={{ character: NO_PROFS }} />
